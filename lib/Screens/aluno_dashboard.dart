  ...
  final List<Map<String, dynamic>> _atividades = [
    {
      ...
      'tipo': 'Tarefa', 
      'data': '05/09',
      'descricao': 'Resolver os exercícios de 1 a 5 da página 15.',
      'concluida': false,
    },
    {
      ...
      'tipo': 'Tarefa', 
      'data': '12/09',
      'descricao': 'Pesquisa sobre a Revolução Industrial.',
      'concluida': false,
    },
    {
      ...
      'tipo': 'Tarefa', 
      'data': '15/09',
      'descricao': 'Escrever um texto dissertativo sobre tecnologia.',
      'concluida': false,
    },
    {
      ...
      'tipo': 'Evento', 
      'data': '10/09',
      'descricao': 'Reunião bimestral no auditório.',
      'concluida': false,
    },
  ];
